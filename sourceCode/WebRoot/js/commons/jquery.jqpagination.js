	...
	$.jqPagination = function (el, options) {
		...
		base.setLinks = function (page) {
			...
			if (current_page === max_page) {
				base.$el.find('.next').addClass('disablednext');
				base.$el.find('.last').addClass('disabledlast');
			}

			if (current_page === 1) {
				base.$el.find('.previous').addClass('disabledprevious');
				base.$el.find('.first').addClass('disabledfirst');
			}

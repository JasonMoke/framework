...
<body>
	...
	<script type="text/javascript">
		...
		var rootNode = { id:'0', pId:'-1', name:'模块', open:true,iconSkin:"home"};
		...
		function zTreeOnlick(event, treeId, treeNode) {
			...
			var cid = nodes[0].id;
			//var pid = nodes[0].pid;
			parent.formModule.location = "<%=request.getContextPath() %>/module/getModuleByCondition.action?ParentId="+cid;
			};
	</script>

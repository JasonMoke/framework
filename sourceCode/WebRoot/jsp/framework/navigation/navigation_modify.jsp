...
<head>
    ...
    */
    ...
    function __submit(){
		if($("#updateForm").valid()){
    		$("#loadingdiv").show();
    		document.updateForm.action="<%=basePath%>navigation/update.action";
...
<body>
<form action="navigation/update.action" name="updateForm" id="updateForm" method="post" target="mainFrame">
	...
	<input type="hidden" id="UUID" name="navigation.UUID" 	value='<s:property value="navigation.UUID" />' />
<div class="controls">  
 ...
 <div class="form-group col-sm-6">
	    ...
	    <div class="col-sm-8">
	    <input class="form-control" name="navigation.NavName" type="text" id="NavName" value="<s:property value="navigation.NavName" />">
	    </div>
</div>
 <div class="form-group col-sm-6">
	    <label class="col-sm-4 control-label text-right">
	    ...
	    <div class="col-sm-8">
	    <input class="form-control" name="navigation.NavUrl" type="text" id="NavUrl"  value="<s:property value="navigation.NavUrl" />">
	    </div>
</div>
 <div class="form-group col-sm-6">
	    <label class="col-sm-4 control-label text-right">
	    ...
	    <div class="col-sm-8">
	    <input class="form-control" name="navigation.UrlPrefix" type="text" id="UrlPrefix" value="<s:property value="navigation.UrlPrefix" />">
	    </div>
</div>
 <div class="form-group col-sm-6">
	    <label class="col-sm-4 control-label text-right">
	    ...
	    <div class="col-sm-8">
	    <input class="form-control" name="navigation.SeqNum" type="text" id="SeqNum" value="<s:property value="navigation.SeqNum" />">
	    </div>
</div>
 <div class="form-group col-sm-6">
	    <label class="col-sm-4 control-label text-right">
	    ...
	    <div class="col-sm-8">
	    <CW:switch name="navigation.Status" id="Status" type="checkbox" />
	    </div>
</div>
 <div class="form-group col-sm-12">
	    ...
	    <div class="col-sm-10">
	    <input class="form-control" name="navigation.HelpFilePath" type="text" id="HelpFilePath" value="<s:property value="navigation.HelpFilePath" />">
	    </div>
</div>
</div>
</form>

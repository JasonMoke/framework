...
<body>
<h3 id="title" class="page-header"></h3>
	<form action="<%=path%>/user/selRoleByUsers.action" name="selUserRoleForm"
		...
		<input type="hidden" name="DictName" id="DictName"  value='<s:property value="DictName" />' />
	</form>
	<script type="text/javascript">
	 $(document).ready(function() {
		var DictName=$("#DictName").val();
		if(DictName!=""){
			$("#title").html("角色("+DictName+")");
		}else{
			$("#title").html("角色");
		}
	});

			    ...
			    success: function(data){ 
			    	if(data=='0'){
			    		if(isPreferences==0){
			    			...
			    			document.addpubmenuForm.action="<%=basePath%>pubmenu/insert.action";
				    		document.addpubmenuForm.submit();
			    		}
			    	}else{
			    			art.dialog.confirm('<s:text name="已有首选项，是否更改首选项？"><s:param><s:text name="确认"></s:text></s:param></s:text>', 
			    			function(){
			    				document.addpubmenuForm.action="<%=basePath%>pubmenu/insert.action?type=1";
					    		document.addpubmenuForm.submit();
			    			}, function(){
...
<body>
 ...
 <h2 class="page-header"><s:text name="添加" /></h2>
<div class="form-actions text-right">  
 ...
 <div class="form-group col-sm-6">
    ...
    <div class="col-sm-8">
      <input class="form-control" name="pubmenu.MenuName" type="text" id="pubmenu.MenuName" >
    </div>
</div>
 <div class="form-group col-sm-6">
    <label class="col-sm-4 control-label text-right">
    ...
    <div class="col-sm-8">
    <input class="form-control" name="pubmenu.PID" id="PID"  type="hidden" value="<s:property value="pubmenu.UUID"/>">
    <input class="form-control" name="PIDName" id="PIDName"  type="text" onclick="_selectPid()" value="<s:property value="pubmenu.MenuName"/>">
    </div>
</div>
...
<div class="form-group col-sm-6">
    ...
    <div class="col-sm-8">
    <input class="form-control" name="pubmenu.HelpFilePath" id="pubmenu.HelpFilePath" type="text" >
    </div>
</div>
<div class="form-group col-sm-6">
    <label class="col-sm-4 control-label text-right">
    ...
    <div class="col-sm-8">
    <input class="form-control" name="pubmenu.SeqNum" id="pubmenu.SeqNum" type="text" >
    </div>
</div>
 <div class="form-group col-sm-6">
    <label class="col-sm-4 control-label text-right">
 ...
 <div class="form-group col-sm-6">
    ...
    <div class="col-sm-8">
    <CW:switch name="pubmenu.Target" id="Target" type="checkbox" checked="false" />
    </div>
</div>
 <div class="form-group col-sm-6">
    <label class="col-sm-4 control-label text-right">
...
<div class="form-group col-sm-6">
    ...
    <div class="col-sm-8">
    <CW:select onchange="_changeType()"  className="form-control" name="pubmenu.MenuType" id="MenuType" codeName="MenuType" isCode="true" field="MenuType" property="MenuType"> 
...
<div id="moduleUrl" class="form-group col-sm-6" style="display: none">
    ...
    <input class="form-control" name="pubmenu.ModuleId" id="ModuleId" type="hidden" >
    <input class="form-control" name="ModuleName" id="ModuleName" type="text" onclick="_selectModule()">
...
<div id="resourceUrl" class="form-group col-sm-6" style="display: none">
    ...
    <div class="input-group col-sm-7 col-sm-offset-7" >
    <input class="form-control" name="pubmenu.ResourcesId" id="ResourcesId" type="hidden" >
    <input class="form-control" name="ResourcesName" id="ResourcesName" type="text" onclick="_selectResource()">
...
<div class="form-group col-sm-6" >
	...
	<s:text name="菜单路径" />：
      ...
      <div class="col-sm-8">
    <input class="form-control" name="pubmenu.MenuUrl" id="MenuUrl" type="text" >
    </div>
</div>
</div>
</form>

...
$(document).ready(
		function() {
			$("#NavId").val($("#NavId",parent.document).val());
...
<body>
	...
	<script type="text/javascript">
		...
		var rootNode = { id:'0', pId:'-1', name:'菜单', open:true,iconSkin:"home"};
		...
		function zTreeOnlick(event, treeId, treeNode) {
			...
			$("#PID").val(cid);
			//var pid = nodes[0].pid;
			parent.rightFrame.location = "<%=request.getContextPath() %>/pubmenu/findList.action?ParentId="+cid+"&NavId="+NavId;
			};
	</script>

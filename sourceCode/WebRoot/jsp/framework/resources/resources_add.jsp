 ...
 */
 $(document).ready(
	...
	function __submit(){
		if($("#srcForm").valid()){
			document.srcForm.action="<%=basePath%>resources/insert.action";
  ...
  <body>
    ...
    <h2 class="page-header"><s:text name="添加资源" /></h2>
	...
	<div class="controls">  
		 ...
		 <div class="form-group col-sm-6">
			    ...
			    <div class="col-sm-8">
			     <CW:switch name="Resources.Status" id="Status" type="checkbox" checked="true" />
			    </div>
		</div>	
		<div class="form-group col-sm-6">
			    <label class="col-sm-4 control-label text-right">
			    ...
			    <div class="col-sm-8">
			     <CW:switch name="Resources.isMenu" id="isMenu" type="checkbox" checked="true" />
			    </div>
		</div>	
		 <div class="form-group col-sm-6">
			    <label class="col-sm-4 control-label text-right">

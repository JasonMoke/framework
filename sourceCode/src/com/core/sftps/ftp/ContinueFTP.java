...
//    	raf.close();   
    ...
    public static void main(String[] args) {   
        ...
        try {   
            myFtp.connect("210.73.60.249", 990, "oneworld", "0new0rld2014;");   
...
//          System.out.println(myFtp.upload("E:\\test.mkv","/Upload/test/test.mkv"));   
            System.out.println(myFtp.download("/test/ecm/9781629785950.mobi", "C:\\Users\\guangchao\\Desktop\\9781629785974111111111111.mobi"));   
            myFtp.disconnect();   
        } catch (IOException e) {   
